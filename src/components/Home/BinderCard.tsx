...
import { exportBinder } from '../../store/exportImport'
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-5 flex flex-col gap-3 hover:border-purple-500 transition-colors group">
      ...
      <div className="flex gap-2 mt-auto">
        ...
        <button
          onClick={() => exportBinder(binder.id)}
          title="Export binder as JSON"
          className="bg-gray-700 hover:bg-gray-600 text-gray-300 text-sm font-medium px-3 py-2 rounded-lg transition-colors"
        >
          ↓
        </button>
      </div>
